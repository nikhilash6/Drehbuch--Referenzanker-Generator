      ...
      try {
        ...
        if (parsed && typeof parsed.windowCount === 'number') {
          return {
            ...
            references: parsed.references && parsed.references.length > 0 ? parsed.references : (parsed.subjects && parsed.subjects.length > 0 ? parsed.subjects : DEFAULT_SUBJECT_REFERENCES),
            subjects: parsed.references && parsed.references.length > 0 ? parsed.references : (parsed.subjects && parsed.subjects.length > 0 ? parsed.subjects : DEFAULT_SUBJECT_REFERENCES),
