...
export const UltraPhysicsCard: React.FC<UltraPhysicsCardProps> = ({ enabled = true, onToggle }) => {
  return (
    <div
        ...
        <div className="space-y-1.5 max-w-2xl">
          <div className="flex items-center gap-2 flex-wrap">
            ...
            >
              ...
              <span>Kinetik &amp; Kausalitäts-Engine</span>
            </span>
            <span
          ...
          <h3 className="text-sm font-bold flex items-center gap-2">
            <span>Physikalische Kausalkette, Mikro-Haptik &amp; Subsurface-Licht</span>
          </h3>
      ...
      {enabled && (
        <div className="mt-4 pt-4 border-t border-zinc-800/80 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-2.5">
          <div className="p-2.5 rounded-xl bg-zinc-900/80 border border-zinc-800/90 flex items-start gap-2">
            ...
            <div>
              <div className="text-[11px] font-bold text-white">Kausale Kettenreaktion</div>
              <div className="text-[10px] text-zinc-400">Kontakt &rarr; Muskelreaktion &rarr; Atemzug &rarr; Textur</div>
            </div>
          </div>
          ...
          <div className="p-2.5 rounded-xl bg-zinc-900/80 border border-zinc-800/90 flex items-start gap-2">
            ...
            <div>
              <div className="text-[11px] font-bold text-white">Specular Streiflicht</div>
              <div className="text-[10px] text-zinc-400">Glanzlichter auf Haut, Leder, Moos &amp; Tau gegen Plastik-Look</div>
            </div>
          </div>
          ...
          <div className="p-2.5 rounded-xl bg-zinc-900/80 border border-zinc-800/90 flex items-start gap-2">
            ...
            <div>
              <div className="text-[11px] font-bold text-white">4-Stufen Dramaturgie</div>
              <div className="text-[10px] text-zinc-400">Exakte Rhythmus-Steigerung (0-4s / 4-9s / 9-13s / 13-15s)</div>
            </div>
          </div>
          ...
          <div className="p-2.5 rounded-xl bg-zinc-900/80 border border-zinc-800/90 flex items-start gap-2">
            ...
            <div>
              <div className="text-[11px] font-bold text-white">Intense Eye-Lock</div>
              <div className="text-[10px] text-zinc-400">Kamera als physischer Körper mit direktem Blickkontakt</div>
            </div>
          </div>
        </div>
      )}
